    ...
    <body>
        <%
            ...
            */ 
            ...
            // response.addHeader("Content-Disposition","attachment; filename=kk.html");  // check: https://coderanch.com/t/360781/java/Servlet-send-RTF 
            //response.addHeader("Content-Disposition","attachment; filename=NotaEntrega3.rtf");  //
            response.addHeader("Content-Disposition","attachment; filename=NotaEntrega3.html");  //
