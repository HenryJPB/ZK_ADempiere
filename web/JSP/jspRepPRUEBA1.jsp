<%-- 
    ...
    Author     : hpulgar
    NOTA: La ejecucion de este reporte se realizo utilizando el editor de Reportes 
    'TIBCO JasperSoft Studio CE v.6.11.0.  
    Su ejecucion fue exitosa cuando se le agrego el .jar jdbc de Postgresql v.42.7.0 al 
    [Window]-[Preferencia]-[Java]-[Classpath variables].  
--%>
...
<html>
    ...
    <body>
        ...
        <%
            String reporte = "NotaPedido(v3-JSS6.21).jasper"; 
            //String reporte = "Reporte02.jasper";  
            ...
            */ 
            ...
            parametros.put( "p_vendedor", "Luis The Campions" );
            /*-*/
